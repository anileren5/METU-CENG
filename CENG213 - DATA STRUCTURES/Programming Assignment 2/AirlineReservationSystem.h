...
private: // YOU MAY ADD YOUR OWN UTILITY MEMBER FUNCTIONS HERE.
    void searchFlight_helper(const std::string &departureCity, const std::string &arrivalCity,BSTNode<Flight>* root,std::vector<Flight *>& searched_flights);
    bool isPassengerExist(BSTNode<Passenger>* root,const std::string &firstname, const std::string &lastname);
    bool isFlightExist(BSTNode<Flight>* root,const std::string &flightCode);
